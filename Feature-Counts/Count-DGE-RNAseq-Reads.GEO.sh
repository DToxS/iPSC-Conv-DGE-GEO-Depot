#!/usr/bin/env bash
# This script counts the number of aligned sequences for 3'-DGE
# mRNA sequence data.

# Set top directory.
DATASET_DIR="${HOME}/LINCSData/Datasets/Alignment/LINCS.Dataset/iPSC-CM/DGE-GEO-Depot"
...
# Set input arguments.
COUNTS_FILE_MAIN_NAME="DGE-RNAseq-Read-Counts"
SEQ_METHOD="dge"
